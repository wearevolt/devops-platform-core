module "secret_manager_unseal_kms_key" {
  ...
  # Key Policy
  key_users          = [module.secret_manager_irsa_role.arn]
  key_administrators = [module.iac_pr_automation_irsa_role.arn]
  key_owners         = [module.iac_pr_automation_irsa_role.arn]
