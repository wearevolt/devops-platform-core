...
output "private_subnet_id" {
  ...
  value       = local.effective_private_subnets
}
output "az_ids" {
  description = "Availability zones ids"
  value       = local.create_vpc ? module.vpc.azs : local.azs
}
output "kms_key_id" {
...
output "efs_csi_irsa_role" {
  ...
  value       = module.efs_csi_irsa_role.arn
}
output "iam_ci_irsa_role" {
  description = "Cloud Native CI IAM role ARN"
  value       = module.iam_ci_role.arn
}
output "iac_pr_automation_irsa_role" {
  description = "IaC PR automation IAM Role ARN"
  value       = module.iac_pr_automation_irsa_role.arn
}
# cert_manager removed - not needed without cert-manager component
...
output "secret_manager_irsa_role" {
  ...
  value       = module.secret_manager_irsa_role.arn
}
...
output "backups_manager_irsa_role" {
  ...
  value       = module.backups_manager_irsa_role.arn
}
output "alb_controller_irsa_role" {
...
output "igw_arn" {
  ...
  value       = local.create_vpc ? module.vpc.igw_arn : ""
}
output "igw_id" {
  description = "IGW ID Generated by VPC module"
  value       = local.create_vpc ? module.vpc.igw_id : ""
}
